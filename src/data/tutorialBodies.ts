...
export const TUTORIAL_BODIES: Record<string, TutorialBody> = {
  'ai-what-is': {
    intro: [
      ...
      '本教程帮你建立入门必备基础：5 个心智模型、四种用法、国内工具怎么选、免费/付费与安全底线。读完再去装软件、练第一次对话。',
    ],
    sections: [
      {
        title: '5 个心智模型（入门必懂）',
        paragraphs: [
          '① LLM：大语言模型，本质是「根据上文猜下一个词」，所以会写得像人，也可能一本正经胡说。',
          '② Token：计费与长度的最小单位，大约几个汉字或半个英文单词算 1～几个 Token；上下文越长越贵、越容易「忘前面」。',
          '③ 上下文窗口：一次对话里模型「记得住」的篇幅上限；超了会丢早期内容，重要约束要重复说或新开对话。',
          '④ 知识截止：训练有截止日期，默认不知道「今天刚发生」的新闻/股价/政策，除非产品开了联网搜索。',
          '⑤ 幻觉：答得流畅不等于正确。数字、人名、法规、代码上线——必须你自己核对。',
        ],
        tip: '把 AI 当实习生：写得快，重要结论你要签字。术语词典里有 LLM / Token / 幻觉等词条可随时查。',
        steps: [
          '用自己的话各写一句：LLM、Token、上下文、截止、幻觉。',
          '想一个你明天要用 AI 的真实任务，标出「哪些事实必须我自己核对」。',
        ],
      },
      {
        title: 'AI 擅长什么、不擅长什么',
        paragraphs: [
          '擅长：把模糊想法变成结构化文字（邮件、大纲、表格）；改写语气与格式；根据报错给改代码建议；按描述生成图片草稿。',
          '不擅长：保证最新事实；精确大数运算；读你没提供的本地文件；替你负法律责任（医疗/合同/投资决策）。',
          '正确用法永远是「AI 起草 + 人工复核」。',
        ],
      },
      {
        title: '四种常见用法对照',
        paragraphs: [
          '对话问答：解释概念、头脑风暴、学习辅导 → 豆包 / Kimi / 通义 / ChatGPT 等聊天页。',
          '写文办公：邮件、纪要、PPT 大纲、调研 → 关键是收件人、语气、长度、格式。',
          '改代码：Trae / 通义灵码 / Cursor 等 IDE → 关键是贴报错、写清技术栈、小步改。',
          '生图：即梦 / 通义万相 / Midjourney 等 → 关键是主体 + 风格 + 光线 + 构图。',
        ],
        steps: [
          '列出本周 3 个真实任务。',
          '每个任务标注：对话 / 写文 / 改代码 / 生图。',
          '需要改本地项目文件 → 别只用网页聊天，去「工具」台阶装 IDE。',
        ],
      },
      {
        title: '国内聊天工具一张表（先选一个就够）',
        paragraphs: [
          '豆包：字节系，网页/App 顺畅，日常聊天与写作够用，手机号注册。',
          'Kimi：长文本/读文档相对强，适合贴长文让它摘要。',
          '通义千问：阿里系，与淘宝/支付宝账号体系亲近，办公与国内场景友好。',
          '智谱清言等：备选；能力各有侧重，不必一次全注册。',
          '新手策略：先固定一个国内产品练到「会提问」，再按需加第二个做对比。',
        ],
        tip: '同一任务可以两个工具各问一遍，对比后再定主力。',
        steps: [
          '选定主力：豆包 / Kimi / 通义 三选一，写进备忘录。',
          '书签收藏其官网，下次不要靠搜索「XX 破解版」。',
        ],
      },
      {
        title: '浏览器 vs 客户端 vs 编程 IDE',
        paragraphs: [
          '浏览器：零安装，适合纯文字；国内产品优先。',
          '官方客户端：体验更稳、有快捷键；ChatGPT/Claude 客户端常需海外网络，打不开就跳过。',
          '编程 IDE：要改本地代码才装；国内优先 Trae.cn / 通义灵码，Cursor 标为可选。',
        ],
        links: [
          { label: '豆包', url: 'https://www.doubao.com/chat/' },
          { label: 'Kimi', url: 'https://kimi.moonshot.cn/' },
          { label: '通义', url: 'https://tongyi.aliyun.com/' },
      ...
      },
      {
        title: '免费版与付费版怎么判断',
        paragraphs: [
          '免费版常见限制：慢模型、日/月额度、高峰限流、高级功能锁。',
          '值得付费的信号：每天用超 30 分钟；免费版经常不够用；编程 Agent 高频改仓库。',
          '国内会员：在对应 App/网页「会员/升级」页看额度说明；先用免费跑通流程再决定。',
        ],
        steps: [
          '连续 3 天记录：免费版哪里够用、哪里卡。',
          '企业场景先问 IT：公司数据能否上公有云 AI。',
        ],
      },
      {
        title: '入门安全底线（还不写代码也要懂）',
        paragraphs: [
          '别把密码、身份证、未公开合同、客户名单贴进公共 AI。',
          '生成内容可能像真的——转载、对外发稿前你要负责核对。',
          '深度伪造（假图/假音）有风险：勿用于欺骗他人。',
          '公司电脑：遵守公司规定；不确定就问 IT。',
        ],
        tip: '详细密钥规范见《API Key 安全》；今天先记住「敏感信息不上传」。',
      },
    ],
    checklist: [
      '能用自己的话解释 LLM / Token / 幻觉',
      '选定一个国内主力聊天产品',
      '给 3 个真实任务标了用法类型',
      '知道敏感信息不能贴进公共 AI',
    ],
    refs: [
      { label: '术语：大语言模型', url: '#glossary' },
      { label: '豆包', url: 'https://www.doubao.com/chat/' },
    ],
  },
  ...
  'ai-account-setup': {
    ...
    sections: [
      ...
      },
      {
        title: '会员与额度：先看懂再掏钱',
        paragraphs: [
          '国内产品：在头像 →「会员 / 开通 / 升级」看每日提问次数、长文额度、是否含更强模型。',
          '免费够用就先别开：入门目标是练提问，不是买会员。',
          '公司账号 vs 个人账号：工作内容尽量用公司许可的工具；个人号别塞公司机密。',
        ],
        steps: [
          '打开你主力产品的会员说明页，记下免费额度关键词（次数/字数/模型名）。',
          '在备忘录写：我目前用【免费/会员】，卡点是【无 / 额度不够 / 要更强模型】。',
        ],
      },
      {
        title: '个人与企业数据边界（一句话规矩）',
        paragraphs: [
          '个人学习：可用公共 AI，但别贴身份证、银行卡、未公开合同。',
          '公司工作：先问 IT/主管「能不能用公有云 AI」；禁止就把客户数据、源码、密钥贴进去。',
          '不确定算不算机密：默认当机密，先脱敏（用假名/打码）再问。',
        ],
      },
      {
        title: '登录失败常见原因（按顺序试）',
  ...
  'ai-first-chat': {
    ...
    sections: [
      ...
      },
      {
        title: '模型档位怎么选（新手别纠结）',
        paragraphs: [
          '多数产品有「快速 / 标准 / 强力 / Max」等档位，名字各不相同。',
          '练手、写邮件草稿、整理笔记：选默认或「快速/标准」——够用且不易被额度卡住。',
          '长文推理、复杂方案、难改的代码：再试「更强」档；仍不行就换产品对比，而不是盲目开最贵会员。',
          '没有模型开关：忽略本节，直接用默认即可。',
        ],
        tip: '入门目标是「问清楚、拿到可用结果」，不是刷榜模型名。',
      },
      {
        title: '上下文：何时追问、何时新开',
        paragraphs: [
          '同一话题继续改（改短、改表格、定稿）：留在当前对话追问，AI 记得前面约定。',
          '换了一个完全无关的任务：点「新对话」，避免旧背景污染。',
          '对话已经很长、开始答非所问：新开，并把关键约束再写一遍。',
          'Share/分享链接：练习可以；含公司数据的对话不要公开分享。',
        ],
        steps: [
          '练习一次：同一对话追问两轮。',
          '再练习一次：新开对话问无关问题，体会差别。',
        ],
      },
      {
        title: '千万别只发三个字',
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          '① 只发三个字：「写周报」——没角色没格式。',
          '② 一次塞十个互不相关的任务——拆开问。',
          '③ 上下文又臭又长还不摘要——先让 AI 摘要再提问。',
          '④ 盲信数字与引用——自己核对。',
          '⑤ 旧对话里换新主题——新开对话。',
          '⑥ 不说验收标准——加「不超过 200 字 / 用表格」。',
          '⑦ 把机密贴进公共 AI——脱敏或别问。',
          '⑧ 搜「破解版」装客户端——只用官网。',
          '⑨ 追最贵模型却不会提问——先练四段式。',
          '⑩ 生成完不复核就发出去——你是责任人。',
        ],
        tip: '避坑指南里有更细的案例；入门先把这十条贴显示器边上。',
      },
    ],
    checklist: [
      '能背诵四段式四个部分名称',
  ...
  'api-keys-security': {
    intro: [
      'API Key 等同于密码。泄露后他人可代你调用模型，账单可在几小时内暴涨。',
      '即使你现在只在网页里聊天、还没写代码，也要先懂「Key 是什么、什么时候才需要」。后面再学 .env 与 Git 规范。',
    ],
    sections: [
      {
        title: '零代码也能懂：API / API Key 是什么',
        paragraphs: [
          '网页聊天：你登录账号，点发送，产品在后台帮你调模型——你通常看不到 Key。',
          'API：程序用「接口」直接调模型的方式，像给机器用的电话线路。',
          'API Key：开通这条线路的通行证，一串以 sk- 等开头的字符。谁拿到，谁就能花你的钱调模型。',
          '你还不需要 API 的情况：只用豆包/Kimi/通义网页或 App 聊天、写邮件、做纪要。',
          '你才需要 Key 的情况：自己写程序调用模型、在 Cursor/Trae 里填「自定义 API」、接兼容网关。',
        ],
        tip: '入门阶段可以只聊天、不碰 Key；一旦开始填 Key，就按下面规范做。',
        steps: [
          '判断自己：本周是否只用网页聊天？是 → 先读完「禁止事项」即可。',
          '若工具要求你粘贴 sk-…：停下来，先学完本篇再填。',
        ],
      },
      {
        title: '密钥是什么、泄露代价多大',
    ...
    checklist: [
      '能说明 API Key 是什么、什么时候才需要',
      '（若已用 Key）.env 已创建且在 .gitignore',
      '代码无 sk- 硬编码',
      '知道 Revoke / 作废密钥入口',
      'Dev/Prod Key 已分离或已列入计划',
    ],
    refs: [
  ...
  'newbie-first-week': {
    intro: [
      ...
      '国内优先：先网页聊天跑通 → 再会提问 → 再办公 → 再懂安全；写代码再装 Trae.cn / 通义灵码，不必第一周就上 Cursor。',
    ],
    sections: [
      {
        title: 'Day1：心智模型 + 第一次对话',
        paragraphs: [
          '先读《AI 是什么》里「5 个心智模型」与「国内工具一张表」，选定一个主力（豆包/Kimi/通义）。',
          '再跟《第一次有效对话》发出第一条结构化消息，拿到能粘贴的结果。',
        ],
        steps: [
          '能用自己的话解释：LLM、幻觉、为什么要复核。',
          '完成一次「新对话 + 模板提问 + 两轮追问」。',
          '写下原则：重要数字和人名我自己核对。',
        ],
      },
      {
        title: 'Day2：官网登录与（可选）安装',
        paragraphs: [
          '跟《下载安装指南》《账号注册》：至少保证浏览器里能稳定登录并发消息。',
          '可选：装官方客户端；要写代码再装 Trae.cn 或通义灵码——今天不必装 Cursor，也不必配 API Key。',
        ],
        steps: [
          '官网登录成功，书签已收藏。',
          '完成隐私三分钟设置（会删对话、不贴密码）。',
          '（可选）Trae/灵码能打开一个本地文件夹。',
        ],
      },
      {
        ...
        paragraphs: [
          ...
          '三个任务建议：改一段工作周报；解释一个不懂的概念；把会议口述转待办表。',
        ],
        steps: [
      ...
      {
        title: 'Day5：安全底线（含「还不需要 Key」）',
        paragraphs: [
          '读《API Key 安全》第一节：懂 API Key 是什么、什么时候才需要。',
          '铁律：密钥=密码；不能贴进公开仓库、群聊截图、前端代码；敏感业务数据不上传公共 AI。',
        ],
        steps: [
          '完成「零代码也能懂」自检：本周是否只需网页聊天。',
          '检查电脑：有没有把 Key 写在桌面记事本？有则立刻作废。',
          '若已有代码项目：确认 .gitignore 含 .env。',
        ],
      },
      {
        title: 'Day6：选方向预习',
        paragraphs: [
          '工具线（要改代码）：Trae / 灵码 /（可选）Cursor —— 见「学习台阶 · 工具」。',
          '作品线：网页 / 小程序 / 生图 —— 见「学习台阶 · 作品」。',
          '今天只预习一篇正文的前两节，列出明天要跟做的 3 个步骤。',
        ],
        steps: [
          '在顶栏「学习台阶」悬停，点进对应一阶。',
          '收藏 1 篇教程，写「卡住时回看哪一节」。',
      ...
      },
      {
        title: 'Day7：复盘',
        paragraphs: [
          '列出本周：AI 代劳节省的时间；翻车 1 次及原因；下周只练一个深度技能。',
        ],
        steps: [
