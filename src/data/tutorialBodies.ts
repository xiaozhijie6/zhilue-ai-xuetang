...
export const TUTORIAL_BODIES: Record<string, TutorialBody> = {
  'ai-what-is': {
    intro: [
      ...
      '本教程帮你建立入门必备基础：几个核心概念、常见用法，以及安全底线。读完再去装软件、练第一次对话。',
    ],
    sections: [
      {
        title: '5 个心智模型（入门必懂）',
      ...
      },
      {
        title: '四种常见用法',
        paragraphs: [
          '对话问答：解释概念、头脑风暴、学习辅导。用浏览器打开任一国内 AI 聊天页即可开始。',
          '写文办公：邮件、纪要、PPT 大纲、调研。关键是写清收件人、语气、长度、格式。',
          '改代码：在编程 IDE 里改本地文件。关键是贴报错、写清技术栈、小步改。',
          '生图：按描述出图。关键是主体 + 风格 + 光线 + 构图写清楚。',
        ],
        steps: [
          '列出本周 3 个真实任务。',
          '每个任务归到：对话 / 写文 / 改代码 / 生图。',
          '需要改本地项目文件 → 去「工具」台阶装 IDE。',
        ],
        links: [
  ...
  'ai-account-setup': {
    ...
    sections: [
      ...
      },
      {
        title: '数据边界（一句话规矩）',
        paragraphs: [
          '别贴身份证、银行卡、未公开合同到公共 AI。',
          '公司工作：先问 IT/主管能否使用；禁止就把客户数据、源码、密钥贴进去。',
          '不确定算不算机密：默认当机密，先脱敏再问。',
        ],
      },
      {
        title: '登录失败常见原因（按顺序试）',
  ...
  'ai-first-chat': {
    ...
    sections: [
      ...
      },
      {
        title: '用默认模型即可',
        paragraphs: [
          '页面上若有模型开关，新手直接用默认项，不必改。',
          '目标是问清楚、拿到可用结果，不是挑选模型名称。',
        ],
      },
      {
        title: '何时追问、何时新开对话',
        paragraphs: [
          '同一话题继续改（改短、改表格、定稿）：留在当前对话追问。',
          '换了一个完全无关的任务：点「新对话」。',
      ...
      },
      {
        title: '千万别只发三个字',
        paragraphs: [
          '效果差的问法：「写周报」「帮我写邮件」「怎么样」。',
          '有效问法必须包含：你是谁、要干什么、给谁看、什么格式、多长。',
    ...
    sections: [
      {
        ...
        paragraphs: [
          '先读《AI 是什么》里「5 个心智模型」，打开任一国内 AI 网页登录。',
      ...
      },
      {
        ...
        paragraphs: [
          ...
          '要写代码再装 Trae.cn 或通义灵码——今天不必配 API Key。',
        ],
        steps: [
          '官网登录成功，书签已收藏。',
          '完成隐私三分钟设置（会删对话、不贴密码）。',
