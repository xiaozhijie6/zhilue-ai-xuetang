...
export const KNOWLEDGE_LIBRARY: KnowledgeItem[] = [
  ...
  course(
    ...
    [
      ...
      ['国内聊天工具一张表：豆包 / Kimi / 通义', 12, '模板'],
      ['浏览器 vs 客户端 vs 编程 IDE', 10, '步骤'],
      ['免费与付费：什么时候再升级', 8, '图文'],
  ...
  course(
    {
      ...
      category: '入门起步',
      level: '入门',
      desc: '注册后第一次对话：选模型、写问题、追问、新开对话时机、保存结果。',
      source: '自有资料',
      hot: true,
      new: true,
    },
  ...
  course(
    {
      ...
      category: '入门起步',
      level: '入门',
      desc: '国内优先的 7 天路径：心智模型 → 登录 → 提问 → 办公 → 安全 → 选方向。',
      source: '自有资料',
      hot: true,
      new: true,
    },
    [
      ...
      ['Day2：官网登录；（可选）Trae/灵码，不必先 Cursor', 35, '实操'],
      ['Day3：四段式提示词 + 十大翻车自查', 35, '实操'],
      ['Day4：邮件 / 纪要 / PPT / 调研各练一次', 30, '实操'],
      ['Day5：懂 API Key 是什么；敏感信息不上传', 25, '清单'],
      ['Day6：选工具线或作品线预习一篇', 30, '图文'],
      ['Day7：复盘：AI 代劳 vs 必须人工', 25, '实操'],
    ],
  ),
