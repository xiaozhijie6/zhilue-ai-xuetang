  ...
  course(
    {
      ...
      hook: '小白逐步：复制下载链接 → 安装 → 打开文件夹 → AI 改掉一行字',
      outcome: '从 cursor.com/download 装好并登录，用 Ctrl+L 成功改掉 hello.txt',
      category: 'AI编程工具',
      level: '工具',
      desc: '官方下载页逐步点击；新建练习文件夹；Ctrl+L 让 AI 改 txt；含 SmartScreen 与排错。',
      source: '自有资料',
      hot: true,
      new: true,
    },
    [
      ['注册 Cursor 账号（Google/GitHub/邮箱）', 10, '步骤'],
      ['Windows：download 页下载与 SmartScreen 处理', 18, '步骤'],
      ['Mac：dmg 拖进应用程序与隐私放行', 12, '步骤'],
      ['首次登录：不要 Skip，授权浏览器', 12, '步骤'],
      ['新建 ai-practice 并用 Open Folder 打开', 15, '实操'],
      ['创建 hello.txt 并保存', 10, '实操'],
      ['Ctrl+L：让 AI 改文件并点 Accept', 20, '实操'],
      ['Settings：模型名与 Privacy Mode', 12, '步骤'],
      ['排错：转圈、装不上、文件没变', 15, '清单'],
    ],
  ),
  course(
    {
