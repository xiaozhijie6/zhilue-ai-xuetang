  ...
  course(
    {
      ...
      category: '下载与入门',
      level: '基础',
      desc: '小白逐步：复制官方网址、点哪个按钮、成功长什么样；含豆包/Kimi/ChatGPT/Claude/Cursor。',
      source: '自有资料',
      hot: true,
      new: true,
      trackStep: 1,
    ...
    [
      ...
      ['先选路线：浏览器够用 vs 再装客户端 vs Cursor', 10, '图文'],
      ['跟做：豆包/Kimi 网页版登录并发第一条消息', 20, '实操'],
      ['Windows：ChatGPT 官方下载页与微软商店安装', 18, '步骤'],
      ['Windows/Mac：Claude 官网下载与权限弹窗', 15, '步骤'],
      ['Mac：ChatGPT 桌面版注意芯片与系统版本', 12, '步骤'],
      ['手机 App：应用商店认准开发者再安装', 12, '步骤'],
      ['Cursor：cursor.com/download 逐步安装入口', 15, '步骤'],
  ...
  course(
    {
      ...
      title: '先选再装：AI 编程工具与智能体地图',
      hook: '别一次装五个：先搞清 IDE / 插件 / 终端 Agent 各适合谁',
      outcome: '按自己场景选出 1 个主工具，再进对应安装教程',
      category: 'AI编程工具与智能体安装',
      level: '工具',
      desc: 'Cursor、Windsurf、Trae、Copilot、Claude Code、Codex 对照与决策树。',
      source: '自有资料',
      hot: true,
      trackStep: 0,
    },
    [
      ['每个工具擅长什么：一张对照表', 15, '模板'],
      ['三类形态：独立 IDE / 插件 / 终端智能体', 12, '图文'],
      ['登录方式 vs API Key：两种用法别混', 12, '图文'],
      ['CC Switch：统一管理 Claude Code / Codex 等密钥', 15, '图文'],
      ['决策树：先装哪个、再装 CC Switch', 15, '步骤'],
      ['装完去哪学：对应安装篇与用法篇', 10, '清单'],
    ],
  ),
  course(
    {
      id: 'install-cc-switch',
      title: 'CC Switch 安装：多工具 API Key 一键切换',
      hook: '装完 Claude Code / Codex 还要换 Key？用 CC Switch 统一管理',
      outcome: '从 GitHub Releases 装好 CC Switch，会添加供应商、填 API Key、一键启用',
      category: 'AI编程工具与智能体安装',
      level: '工具',
      desc: '官网 ccswitch.io；Windows MSI / Mac brew；添加供应商、Base URL、API Key、切换生效。',
      source: '自有资料',
      hot: true,
      new: true,
    },
    [
      ['CC Switch 擅长什么：管配置，不替代编程工具', 10, '图文'],
      ['官网与 GitHub Releases：认准官方下载', 12, '步骤'],
      ['Windows：MSI 或便携版安装', 15, '步骤'],
      ['Mac：Homebrew 或 dmg 安装', 12, '步骤'],
      ['首次启动：导入已有 Claude Code / Codex 配置', 15, '实操'],
      ['添加供应商：名称、Base URL、API Key', 20, '实操'],
      ['启用切换：主界面 / 托盘；何时重启终端', 15, '步骤'],
      ['恢复官方登录：官方预设 + 重新 Log in', 12, '步骤'],
      ['安全：Key 不外传、只从官方站下载', 10, '清单'],
    ],
  ),
  course(
    {
      id: 'cursor-install',
      title: 'Cursor 安装：官网下载到第一次改文件',
      hook: 'Cursor 擅长可视化改多文件；本篇：下载 → 登录 → API Key → 验证',
      outcome: '装好并登录 Cursor，会配 API Key（可选），用 Chat 改掉 hello.txt',
      category: 'AI编程工具与智能体安装',
      level: '工具',
      desc: '擅长场景说明；官方下载；账号登录；Settings 配模型/API Key；第一次改文件。',
      source: '自有资料',
      hot: true,
      new: true,
    },
    [
      ['Cursor 擅长什么：日常写功能、多文件、看 Diff', 10, '图文'],
      ['官网 download 安装 Windows / Mac', 18, '步骤'],
      ['账号登录：Google / GitHub / 邮箱（勿 Skip）', 12, '步骤'],
      ['Open Folder + 第一次 Ctrl+L 改文件', 20, '实操'],
      ['配置 API Key / Base URL（自带额度不够时）', 18, '步骤'],
      ['与 CC Switch 的关系：CLI 密钥用 CC Switch 管', 10, '图文'],
      ['排错：登录、Key 无效、不改文件', 15, '清单'],
    ],
  ),
  course(
    {
      id: 'install-claude-code',
      title: 'Claude Code 安装：终端编程智能体',
      hook: 'Claude Code 擅长仓库级重构；装好后登录，再用 CC Switch 管 API Key',
      outcome: 'claude 能启动并登录；会用官方登录或 CC Switch 配 API Key',
      category: 'AI编程工具与智能体安装',
      level: '工具',
      desc: '擅长场景；官方安装；OAuth 登录；API Key；对接 CC Switch。',
      source: '自有资料',
      hot: true,
      new: true,
    },
    [
      ['Claude Code 擅长什么：长任务、重构、终端闭环', 10, '图文'],
      ['官方脚本安装 Windows / Mac', 18, '步骤'],
      ['首次 claude 与浏览器登录（官方账号）', 18, '实操'],
      ['API Key 路线：何时不用订阅登录', 15, '图文'],
      ['用 CC Switch 添加供应商并启用到 Claude Code', 20, '实操'],
      ['切换后验证：新开终端再跑 claude', 12, '实操'],
      ['排错：命令找不到、鉴权失败、Key 无效', 15, '清单'],
    ],
  ),
  course(
    {
      id: 'install-codex',
      title: 'OpenAI Codex 安装：CLI 编程智能体',
      hook: 'Codex 擅长 OpenAI 生态下的终端 Agent；登录 + API Key + CC Switch',
      outcome: 'codex 能启动；会官方登录或用 CC Switch 写入 API Key',
      category: 'AI编程工具与智能体安装',
      level: '工具',
      desc: '擅长场景；官方安装；登录；API Key；CC Switch 同步到 Codex。',
      source: '自有资料',
      hot: true,
      new: true,
    },
    [
      ['Codex 擅长什么：OpenAI 系 CLI Agent', 10, '图文'],
      ['官方脚本 / npm @openai/codex 安装', 18, '步骤'],
      ['首次运行与 ChatGPT/OpenAI 登录', 15, '实操'],
      ['API Key：platform.openai.com 创建与保存', 15, '步骤'],
      ['用 CC Switch 把 Key 配进 Codex', 20, '实操'],
      ['验证：只读任务 + 可选写文件', 12, '实操'],
      ['排错：装错包名、鉴权、需重启终端', 15, '清单'],
    ],
  ),
  course(
    {
      id: 'install-copilot',
      title: 'GitHub Copilot 安装：VS Code 插件路线',
      hook: 'Copilot 擅长行内补全；GitHub 登录为主，一般不靠 CC Switch',
      outcome: 'VS Code 装好 Copilot，GitHub 登录后补全与 Chat 可用',
      category: 'AI编程工具与智能体安装',
      level: '工具',
      desc: '擅长场景；VS Code + 扩展；GitHub 登录；订阅说明；与 CC Switch 边界。',
      source: '自有资料',
      new: true,
    },
    [
      ['Copilot 擅长什么：补全快、GitHub 生态', 10, '图文'],
      ['安装 VS Code 与 Copilot 扩展', 15, '步骤'],
      ['GitHub 登录授权', 15, '步骤'],
      ['验证补全与 Chat', 15, '实操'],
      ['API/企业密钥：极少用到时的说明', 10, '图文'],
      ['和 CC Switch：管 CLI 用，不管 Copilot 订阅', 8, '图文'],
      ['排错：无补全、登不上', 12, '清单'],
    ],
  ),
  course(
    {
      id: 'install-windsurf',
      title: 'Windsurf 安装：Cascade 智能体编辑器',
      hook: 'Windsurf 擅长 Cascade 多智能体改项目；登录后按需配模型/Key',
      outcome: '装好并登录 Windsurf，Cascade 能改文件，知道 Key 在哪配',
      category: 'AI编程工具与智能体安装',
      level: '工具',
      desc: '擅长场景；官网安装；账号登录；模型/API 配置入口；与 CC Switch 边界。',
      source: '自有资料',
      new: true,
    },
    [
      ['Windsurf 擅长什么：Cascade 代理式改代码', 10, '图文'],
      ['官网下载安装与账号登录', 18, '步骤'],
      ['Cascade 第一次改文件验证', 18, '实操'],
      ['设置里配置模型或自带 API Key（若提供）', 15, '步骤'],
      ['和 CC Switch：终端 Agent 密钥另管', 8, '图文'],
      ['排错：登录、无响应', 12, '清单'],
    ],
  ),
  course(
    {
      id: 'install-trae',
      title: 'Trae 安装：国产 AI 编程 IDE',
      hook: 'Trae 擅长中文场景 AI 编程；登录后按设置配模型/Key',
      outcome: 'Trae 安装登录成功，会找设置配 API，完成一次改文件',
      category: 'AI编程工具与智能体安装',
      level: '工具',
      desc: '擅长场景；官网安装；登录；API/模型配置；与 CC Switch 边界。',
      source: '自有资料',
      new: true,
    },
    [
      ['Trae 擅长什么：中文友好的 AI IDE', 10, '图文'],
      ['官网下载安装与登录', 18, '步骤'],
      ['设置中配置模型或 API Key', 15, '步骤'],
      ['第一次 AI 改文件验证', 18, '实操'],
      ['和 CC Switch：CLI 工具另装另管', 8, '图文'],
      ['排错：登录、Key、网络', 12, '清单'],
    ],
  ),
...
export const LEARNING_PATHS: LearningPath[] = [
  ...
  },
  {
    id: 'path-tools',
    title: '工具：安装智能体 + 用法深潜',
    desc: '先装 Cursor/Claude Code/Codex 等，再学用法、API 与 MCP',
    count: 0,
    courseIds: [
      'tool-pick-compare',
      'install-cc-switch',
