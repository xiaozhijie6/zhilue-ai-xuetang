...
export const TRACKS: TrackDef[] = [
  ...
  },
  {
    ...
    badge: '02 工具',
    title: 'AI 编程工具与智能体',
    hook: '国内直连优先：先装 Trae / 灵码，不翻墙也能改代码',
    promise: '国内能装 · 登得进 · 会改文件 · 可选再碰海外',
    days: '建议 3–7 天',
    color: '#e8891c',
    steps: [
      {
      ...
      {
        title: '国内直连安装（优先）',
        result: 'Trae.cn + 通义灵码跑通；需要中转 Key 再装 CC Switch',
      ...
      {
        title: '装好后学用法',
        result: 'Rules、Agent 与接口配置按需深入',
        courseIds: ['cursor', 'cursor-rules', 'claude-code', 'api-compatible', 'mcp-intro'],
      },
    ],
  },
  {
